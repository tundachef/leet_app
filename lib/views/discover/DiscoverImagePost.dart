...
// import '../main.dart';
// import 'colors.dart';
import 'DiscoverTextPost.dart';
import 'DiscoverVideoPost.dart';

class DiscoverImagePost extends StatefulWidget {
  ...
  @override
  _DiscoverImagePostState createState() => _DiscoverImagePostState();
}

class _DiscoverImagePostState extends State<DiscoverImagePost>
    with AutomaticKeepAliveClientMixin<DiscoverImagePost> {
  bool isReposted;
  // bool isLaughed;
  // bool isHated;
  // bool isLoved;
                  ...
                  children: <Widget>[
                    ...
                    GestureDetector(
                      onTap: () {
                        showToast('Create Account First', context);
                        // can_download
                        //   n  ? downloadFile(url: widget.link, name: widget.name)
                        //     : null;
                      },
                      child: can_download
                          ? Icon(
